        ...
        try:
            ...
            for entry in profile.merge_axes:
                merge_axis = MergeAxis(
                    ...
                    f_initial_value_lower = entry["lower"].get("f_initial_value", 0.00),
                    f_initial_value_upper = entry["upper"].get("f_initial_value", 0.00),
...
class MergeAxis:
    ...
    def __init__(
            ...
            vjoy_id: int,
            input_id: int,
            f_initial_value_lower: float,
            f_initial_value_upper: float,
            operation: gremlin.common.MergeAxisOperation
    ):
        self.axis_values = [f_initial_value_lower, f_initial_value_upper]
